...
export class InscriptionComponent implements OnInit {
  ...
  constructor(
    ...
    this.registraFormInscription = this.fb.group({
      ...
      tituloSolucion: [
        '',
        [Validators.pattern(/^[a-zA-ZÀ-ÿ\s]{2,100}$/), Validators.required],
      ],
      descripcionSolucion: [
        '',
        [Validators.pattern(/^[a-zA-ZÀ-ÿ\s]{2,2000}$/), Validators.required],
      ],
      nombreEquipo: [
        '',
        [Validators.pattern(/^[a-zA-ZÀ-ÿ\s]{2,40}$/), Validators.required],
      ],
